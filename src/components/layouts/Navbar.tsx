      ...
      <div className="navbar-inner">
        <div className="navbar-left">
          <div className="logo-wrapper">
            <a
              href="#home"
              className={`navbar-logo-link ${scrolled ? 'visible' : 'hidden'}`} 
            >
              <img src={logoImg} alt="GTP Logo" className="navbar-logo-img" />
            </a>

            <div className={`navbar-socials ${scrolled ? 'hidden' : 'visible'}`}>
              ...
              <a href="https://www.facebook.com/gtpanama/?locale=es_LA" target="_blank" rel="noreferrer"><FaFacebook /></a>
